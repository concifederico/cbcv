...
class wxVideoFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.label_7_copy = wx.StaticText(self.notebook_5_pane_1, wx.ID_ANY, u"Tiempo de residencia (min)",
                                          style=wx.ALIGN_CENTER)
        self.label_tiempococcion = wx.StaticText(self.notebook_5_pane_1, wx.ID_ANY, "0.0", style=wx.ALIGN_CENTER)
        self.label_7_copy_copy = wx.StaticText(self.notebook_5_pane_1, wx.ID_ANY, "Largo < LIE (%)",
                                               style=wx.ALIGN_CENTER)
